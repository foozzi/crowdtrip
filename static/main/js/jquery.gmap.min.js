    ...
    var e = google.maps,
        ...
        f = {
            ...
            _renderCluster: function() {
                ...
                if (d = a.gmap.getBounds()) {
                    var g = d.getNorthEast(),
                        e = d.getSouthWest(),
                        k = [],
                        m = (g.lat() - e.lat()) * h.clustering.clusterSize / 100;
                    ...
                    for (d = 0; d < k.length; d += 1) {
                        g = -1;
                        for (b = 0; b < c.length && !(e = c[b].dist(k[d]), e < m && (g = b, h.clustering.fastClustering)); b += 1); - 1 === g ? (b = new p, b.addMarker(k[d]), c[c.length] = b) : c[g].addMarker(k[d])
                    }
            ...
            _processMarker: function(a, b, c, h) {
                ...
                }, f.log && console.log("setup popup with data"), f.log && console.log(c), n = new e.InfoWindow(c), e.event.addListener(k, "click", function() {
                    f.log &&
            ...
            _autoZoom: function(a, b) {
                var c = j(this).data("gmap"),
                    e = j.extend({}, c ? c.opts : {}, a),
                    d, g, c = 39135.758482;
            ...
            addMarker: function(a) {
                ...
                var c = b.icon.image,
                    ...
                    j = b.icon.shadow,
                    k = new e.Size(b.icon.shadowsize[0], b.icon.shadowsize[1]),
                    m = new e.Point(b.icon.shadowanchor[0], b.icon.shadowanchor[1]);
